            ...
            <div class="modal">
                <label class="modal-box relative" for="">
                    ...
                    <div class="modal-action justify-center mt-2 gap-2">
                        ...
                        <Link class="btn btn-outline btn-primary" :href="route('leaderboard', {event: currentEvent.slug})" v-if="!!$page.props?.appSettings?.show_leaderboard.value">Leaderboard</Link>
...
export default {
    ...
    methods: {
        startGame() {
            ...
            axios
                .post(route('start-game', {event: currentEvent.slug}))
                .then((res) => {
        ...
        guessWord() {
            if(!this.actionsDisabled) {
                ...
                this.actionsDisabled = true;
                axios
                    .post(route('game-action', {event: currentEvent.slug}), {
                        action: 'guessWord',
