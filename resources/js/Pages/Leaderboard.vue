<template>
    <div class="container min-h-screen flex flex-col items-center mx-auto py-8 px-4">
        <div class="sm:max-w-3xl w-full rounded-xl flex flex-col items-center">
            <h1 class="font-bold text-center text-primary text-4xl md:text-5xl mb-0 sm:mb-5 underline underline-offset-4">Leaderboard</h1>
