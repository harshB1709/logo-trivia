                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                                ...
                                                <!-- Team Settings -->
                                                <DropdownLink :href="route('teams.show', currentUser.current_team)">
                                                    Team Settings
                                                </DropdownLink>
                                                ...
                                                <template v-for="team in currentUser.all_teams" :key="team.id">
                                                    <form @submit.prevent="switchToTeam(team)">
                                                        <DropdownLink as="button">
                                                            <div class="flex items-center">
                                                                <svg v-if="team.id == currentUser.current_team_id" class="mr-2 h-5 w-5 text-green-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <button v-if="$page.props.jetstream.managesProfilePhotos" class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                                            <img class="h-8 w-8 rounded-full object-cover" :src="currentUser.profile_photo_url" :alt="currentUser.name">
                                        </button>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="flex items-center px-4">
                            <div v-if="$page.props.jetstream.managesProfilePhotos" class="shrink-0 mr-3">
                                <img class="h-10 w-10 rounded-full object-cover" :src="currentUser.profile_photo_url" :alt="currentUser.name">
                            </div>
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                ...
                                <!-- Team Settings -->
                                <ResponsiveNavLink :href="route('teams.show', currentUser.current_team)" :active="route().current('teams.show')">
                                    Team Settings
                                </ResponsiveNavLink>
