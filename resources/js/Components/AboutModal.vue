<template>
    ...
    <div @click="closeModal" class="modal cursor-pointer ubuntu-mono">
      <label class="modal-box relative max-w-2xl w-11/12" for="" @click.stop="">
        ...
        <p class="pt-3 pb-1 text-lg">Welcome to our game! Our team of developers and designers created this project as a fun way to test and expand your knowledge of different software development technologies. Our goal is to provide an entertaining experience that can be enjoyed by anyone interested in tech.</p>
        <div>
